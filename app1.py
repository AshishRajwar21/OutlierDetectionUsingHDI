...
def outlier_detection(X, k, dimension, density_percentile):
    ...
    #     outlier_scores[i] = curr_max_density / p_x
    #     # outlier_scores[i] = p_x / curr_max_density
    # print("Index   Density    OutlierScore")
    # for x in matrix :
    #     print(x[0]," ",x[1]," ",x[2])
    return outlier_scores,matrix
...
outlier_scores,matrix = outlier_detection(new_X, k, dimension, density_percentile=10)
...
output_file = "matrix_output04.xlsx"
